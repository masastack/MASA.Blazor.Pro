...
{
    public static List<InvoiceRecordDto> GetInvoiceRecordList() => new List<InvoiceRecordDto> {
    ...
    public static List<BillDto> GetBillList() => new List<BillDto>
    {
    ...
    public static List<InvoiceStateDto> GetStateList() => new List<InvoiceStateDto>()
    {
